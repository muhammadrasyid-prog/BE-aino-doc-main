...
func Route() *echo.Echo {
	...
	e.GET("/product/sorted", controller.GetSortedProduct)
	...
	// Tour Guide routes
	superAdmin.POST("/tour/add", controller.AddTourGuide)
	superAdmin.PUT("/tour/update/:id", controller.UpdateTourGuide)
	superAdmin.PUT("/tour/delete/:tour_name", controller.DeleteTourGuideByName)
	superAdmin.PUT("/tour/step/delete/:id", controller.DeleteTourStep)
	e.GET("/tour/:id", controller.ShowTourById)
	e.GET("/tours", controller.GetAllTourGuides)
	e.GET("/tour/steps/:tour_name", controller.GetTourWithStepsByName)

	// Timeline history routes untuk superadmin dan admin
	superAdmin.GET("/timeline/history", controller.GetTimelineHistory)
	adminGroup.GET("/timeline/history", controller.GetTimelineHistory)
